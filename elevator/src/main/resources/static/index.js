    ...
    if (personData != "") {
        $.ajax({
            ...
            success: function (res) {
                ...
                elevator4Down = obj[7];
                if(obj.length <= 7){
                    var upMaxFloor1 = obj[4].upMaxFloor3;
                    var upMinFloor1 = obj[4].upMinFloor3;
                    var downMaxFloor1 = obj[4].downMaxFloor3;
                    var downMinFloor1 = obj[4].downMinFloor3;
                    var upMaxFloor2 = obj[4].upMaxFloor1;
                    var upMinFloor2 = obj[4].upMinFloor1;
                    var downMaxFloor2 = obj[4].downMaxFloor1;
                    var downMinFloor2 = obj[4].downMinFloor1;
                    var upMaxFloor3 = obj[4].upMaxFloor2;
                    var upMinFloor3 = obj[4].upMinFloor2;
                    var downMaxFloor3 = obj[4].downMaxFloor2;
                    var downMinFloor3 = obj[4].downMinFloor2;
                    var upMaxFloor4 = obj[4].upMaxFloor4;
                    var upMinFloor4 = obj[4].upMinFloor4;
                    var downMaxFloor4 = obj[4].downMaxFloor4;
                    var downMinFloor4 = obj[4].downMinFloor4;
                }else{
